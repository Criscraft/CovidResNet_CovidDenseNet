...
class CovidResNet(nn.Module):
    def __init__(self, 
        ...
        n_layers_to_be_removed_from_blocks = [0,1,4,2]
        freeze_features_until = 'layer2' #exclusive
        
        self.embedded_model = resnet50(pretrained=b_pretrained, num_classes=n_classes)
    ...
    def forward(self, batch, b_return_features=False):
